<h1 align="center">¡Hola! Soy Joss Adrey 👋</h1>

<p align="center">
  <em>Ingeniero en Informática · Project Manager · Consultor TI</em><br>
  <sub>📍 Ciudad de México · 🏢 AD Ingenia</sub>
</p>
...
Ingeniero en Informática egresado del **IPN — UPIICSA**, con experiencia liderando proyectos de transformación digital, implementación de plataformas y dirección de equipos multidisciplinarios. Mi enfoque: **entender la tecnología como ventaja competitiva** para maximizar resultados y aportar información oportuna y confiable en la toma de decisiones.

Me especializo en **dirección de proyectos (PM)**, plataformas LMS, eCommerce y automatización de procesos con IA.
...
`Asana` · `Monday` · `Jira` · `Trello` · `MS Project` · **Scrum** · **Kanban** · **Six Sigma** · **CPM/CCPM** · **PMBOK**
...
🎓 **UCamp.io (Universidad UTEL)** — Coach de Bootcamp (2020–2023)  
Transformación digital, WordPress avanzado y WooCommerce escalable.

🏛️ **ICAT CDMX** — Instructor certificado bajo el estándar **EC0217**  
Cursos de redes sociales, marketing digital, Excel y programación.
...
- 🔐 **2024** — Ciberseguridad para Entornos WordPress/Odoo
- 🧠 **2024** — Inteligencia Artificial para Negocios (ChatGPT, AutoML)

---

## 🌎 Idiomas

🇪🇸 Español (nativo) · 🇬🇧 Inglés B2 · 🇫🇷 Francés básico–intermedio
